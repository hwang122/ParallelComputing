...
void gauss();  /* The function you will provide.
		...
		*/
void back_substitution(); /* The funciton will do the back substitution job.
			   * Since it will not do parallelly, I move the function out gauss().
			   */
...
void gauss() {
   ...
   * I tried several ways to schedule the parallel, static, dynamic and guided, it seems that static can
